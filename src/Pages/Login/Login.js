...
import { validateEmail,validatePassword,validatePhone } from '../../Helper/Validate';
    ...
    <div className='LoginPage'>
      ...
      <div className="wrapper">
        ...
        <form method='POST' onSubmit={handleForm} className="form" >
          ...
          <InputBox onChange={handleChange} value={formData.userName} name="userName" type="text" htmlFor="Email" Content="EMAIL OR PHONE NUMBER" className="SpaceRequired" />
          
          <InputBox onChange={handleChange} value={formData.password} name="password" type="password" htmlFor="Password" Content="PASSWORD" className="SpaceNotRequired" />
          <p className='forgotpassword'><a href='#'>Forgot your password?</a></p>
          
          <Button type = "submit " value="Log In" className="ButtonLogin" />
          <p className='Register'>Need an account? <Link to='/register'>Register</Link></p>
        </form>
      </div>
      <div className='horizontal-seperator'></div>
        <div className="qr">
          ...
          <p className='qrsubtext'>Scan this with the <strong>Discord mobile app</strong> to log in instantly.</p>
          </div>
        </div>
      </div>
      </div>
