...
function CreateServerModal({ setcreatesev, addServerModalRef }) {
  ...
  const handleForm = (e) => {
    ...
    fromdata.append("servername", formDataState.servername);
    fromdata.append("image", formDataState.serverimage);
    console.log(fromdata);

    // axios
    //   .post("http://192.168.1.65:7070/user/createserver", fromdata, {
    //     headers: {
          ...
          <div className="secondarycontainer3">
            <div className="ContentContainer">
              ...
              <InputBox
                ...
                name="serverimage"
                value={formDataState.serverimage}
              />
            </div>
            <form
            ...
            >
              <InputBox
                ...
                type="text"
                name="servername"
                value={formDataState.servername}
                placeholder="d3f4u1t3d's server"
