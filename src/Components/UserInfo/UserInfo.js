...
function UserInfo() {
  ...
  const [deafenState, setDeafenState] = useState(0);
      ...
      <section className="bottom_panel">
        ...
        <div className="buttons-container">
          <Button
            ...
            data_tip={muteState === 0 ? "Unmute" : "Mute"}
            onClick={() => {
              if (deafenState === 1) {
                setMuteState(0);
              } else {
                setMuteState(muteState === 0 ? 1 : 0);
              }
            }}
            value={
              muteState ? (
          ...
          <Button
            type=""
            className="switcher tipper"
            data_tip={deafenState === 0 ? "Deafen" : "Undeafen"}
            onClick={(e) => {
              setDeafenState(deafenState === 0 ? 1 : 0);
              setMuteState(deafenState);
            }}
            value={
              deafenState === 0 ? (
                <svg width="20" height="20" viewBox="0 0 24 24">
