    ...
    <>
      <section className="bottom_panel">
                ...
                <div className="buttons-container">
                    <Button type="" className="switcher tipper" data_tip="Unmute" value={<svg width="20" height="20" viewBox="0 0 24 24">
                    ...
                    <Button type="" className="switcher tipper" data_tip="Deafen" value={<svg width="20" height="20" viewBox="0 0 24 24">
                    ...
                    <Button type="" className="switcher tipper" data_tip="User Settings" value={<svg width="20" height="20" viewBox="0 0 24 24">
