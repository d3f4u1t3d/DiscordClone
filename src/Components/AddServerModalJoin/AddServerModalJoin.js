        ...
        <div className="overlay" ref={joinRef}>
            <div className="modalContainer2">
                <div className="modalHeader2">
                    ...
                    <p className="modalsubtext2">Enter an invite below to join an existing server</p>
                    <Button
                ...
                <form action="POST"><InputBox onChange={handleChange} type="text" name="link" value={formData.link} className="JoinServer2" placeholder="https://disccord.gg/hTKzmak"/></form>
                ...
                <ButtonWithImageAndDiv img={JoinServer} imgClassName="img" text1="Don't have an invite?" text1ClassName="buttonText1" className="photobutton2" text2="Check out public communities in Server Discovery" text2ClassName="smallText" />
                </div>
                <div className="JoinContainer2">
                    <Button value="Back" className="noborder" onClick={()=> {joinRef.current.classList.remove("show");AddServerModalRef.current.classList.add("show")}} />
                    <Button className="JoinServer23" value="Join Server" onClick={handleForm} />
                 </div>
            </div>
        </div>
    </div>
